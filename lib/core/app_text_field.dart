  ...
  FormFieldValidator<String>? applyValidation() {
    if (widget.isValidationRequired??true) {
      if (widget.validator != null) {
        ...
        return (s) {
          if (s!.trim().isEmpty) {
            return widget.errorThisFieldRequired ?? 'This field is required';
          }
          return null;
        };
        ...
        return (s) {
          ...
          if (s.contains(' ')) {
            return widget.errorInvalidUsername??'Username should not contain space';
          }
          return null;
        };
